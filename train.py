...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=30)  # 500200 batches at bs 16, 117263 images = 273 epochs
    ...
    parser.add_argument('--cfg', type=str, default='cfg/klpd.cfg', help='cfg file path')
    # parser.add_argument('--data', type=str, default='data/coco.data', help='*.data file path')
    parser.add_argument('--data', type=str, default='data/klpd.data', help='*.data file path')
    ...
    # parser.add_argument('--evolve', action='store_true', default=True, help='evolve hyperparameters')
